...
.sh-island-underglow {
    ...
    opacity: 0;
    pointer-events: none;
    transition: opacity 450ms ease, width 850ms cubic-bezier(0.34, 1.56, 0.64, 1), height 750ms cubic-bezier(0.34, 1.56, 0.64, 1);
}
...
.sh-dynamic-island.sh-dropdown-active {
    ...
    transition: 
        ...
        box-shadow 460ms cubic-bezier(0.34, 1.56, 0.64, 1);
}
...
.sh-dynamic-island.sh-island--expanded .sh-nav-brand {
    ...
    filter: blur(0px);
    transition: opacity 350ms cubic-bezier(0.16, 1, 0.3, 1) 120ms, transform 450ms cubic-bezier(0.34, 1.56, 0.64, 1) 100ms, filter 300ms ease 120ms;
}
...
.sh-dynamic-island.sh-island--expanded .sh-nav-tabs {
    ...
    transform: scale(1);
    filter: blur(0px);
    transition: opacity 320ms cubic-bezier(0.16, 1, 0.3, 1) 150ms, transform 420ms cubic-bezier(0.34, 1.56, 0.64, 1) 130ms, filter 300ms ease 150ms;
}
...
.sh-dynamic-island.sh-island--expanded .sh-nav-actions {
    ...
    transform: translateX(0) scale(1);
    filter: blur(0px);
    transition: opacity 350ms cubic-bezier(0.16, 1, 0.3, 1) 180ms, transform 450ms cubic-bezier(0.34, 1.56, 0.64, 1) 160ms, filter 300ms ease 180ms;
}

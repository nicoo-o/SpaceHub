...
(function() {
    ...
    const LOG = (...args) => console.log('[SpaceHub SeriesInfo]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub SeriesInfo]', ...args);
    const ERR = (...args) => console.error('[SpaceHub SeriesInfo]', ...args);
    ...
    function initializeSeriesInfoHook() {
        ...
        LOG('Registering series info handler with SpaceHubUtils');
    ...
    console.log('[SpaceHub SeriesInfo] Module loaded and ready');
})();

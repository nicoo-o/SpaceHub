...
(function() {
    ...
    const cardBuilder = {
        ...
        renderCardsFromIds: async function(itemIds, title, viewMoreUrl = null, overflowCard = false, cardFormat = null, sortOrder = null, sortOrderDirection = 'Ascending') {
            const LOG = (...args) => console.log('[SpaceHub CardBuilder]', ...args);
            ...
            try {
                ...
                console.error('[SpaceHub CardBuilder] Error fetching items:', error);
                return createScrollableContainer([], title, viewMoreUrl, overflowCard, cardFormat);
            }
        },
                ...
                try {
                    ...
                    if (window.apiHelper && window.apiHelper.playItem) {
                        ...
                        if (window.ApiClient && typeof window.ApiClient.play === 'function') {
                            ...
                            console.error('[SpaceHub CardBuilder] No play method available');
                        }
                    }
                } catch (error) {
                    console.error('[SpaceHub CardBuilder] Error playing item:', error);
                }
            });
    ...
    console.log('[SpaceHub CardBuilder] Module loaded and available at window.cardBuilder');
})();

// SpaceHub Flatten Single Season Shows
...
(function() {
    ...
    const LOG = (...args) => console.log('[SpaceHub FlattenSingleSeasonShows]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub FlattenSingleSeasonShows]', ...args);
    const ERR = (...args) => console.error('[SpaceHub FlattenSingleSeasonShows]', ...args);
    ...
    function initializeFlattenHook() {
        ...
        LOG('Registering flatten single season shows handler with SpaceHubUtils');

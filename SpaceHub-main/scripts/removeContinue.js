...
(function() {
    ...
    const LOG = (...args) => console.log('[SpaceHub RemoveContinue]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub RemoveContinue]', ...args);
    const ERROR = (...args) => console.error('[SpaceHub RemoveContinue]', ...args);

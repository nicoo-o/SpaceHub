...
(function() {
    ...
    const LOG = (...args) => console.log('[SpaceHub Playlist]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub Playlist]', ...args);
    const ERR = (...args) => console.error('[SpaceHub Playlist]', ...args);
    ...
    const STORAGE_KEY_PREFIX_SORT = 'SpaceHub_playlistSort_';
    const STORAGE_KEY_PREFIX_DIRECTION = 'SpaceHub_playlistSortDirection_';
    ...
    function initializePlaylistHook() {
        ...
        LOG('Registering playlist handler with SpaceHubUtils');
    ...
    console.log('[SpaceHub Playlist] Module loaded and ready');
})();

(function() {
    ...
    const LOG = (...args) => console.log('[SpaceHub APIHelper]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub APIHelper]', ...args);
    const ERR = (...args) => console.error('[SpaceHub APIHelper]', ...args);
    ...
    async function isAdmin() {
        try {
            ...
            console.warn('[SpaceHub APIHelper] Could not check admin status:', error);
        }
        return false;
    }
    ...
    console.log('[SpaceHub APIHelper] Module loaded and available at window.apiHelper');
})();
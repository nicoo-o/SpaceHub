...
|---|---|---|---|
| 2 | **Formatage & petites puretés** | `_formatTime`, `_escapeUrl`, `_animateButtonSpring`, `_triggerRippleSkip`, utilitaires de ticks | Zéro état réseau, zéro DOM lourd : la peau la plus sûre pour roder la mécanique ; supprime les helpers que chaque future peau voudra importer. |

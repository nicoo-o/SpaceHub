// SpaceHub IndexedDB Cache Manager
...
(function() {
    ...
    const LOG = (...args) => console.log('[SpaceHub IndexedDBCache]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub IndexedDBCache]', ...args);
    const ERR = (...args) => console.error('[SpaceHub IndexedDBCache]', ...args);
    ...
    class IndexedDBCache {
        constructor(prefix = 'SpaceHub_', ttl = 24 * 60 * 60 * 1000) {
            this.prefix = prefix;
            this.ttl = ttl;
            this.db = null;
        }

...
// Usage: window.SpaceHubToaster.toast(message, duration)

(function() {
    'use strict';
    
    // Common logging function
    const LOG = (...args) => console.log('[SpaceHub Toaster]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub Toaster]', ...args);
    const ERR = (...args) => console.error('[SpaceHub Toaster]', ...args);
    ...
    window.SpaceHubToaster = {
        toast
    };
    
    LOG('Initialized successfully');
    LOG('Available at window.SpaceHubToaster');
})();

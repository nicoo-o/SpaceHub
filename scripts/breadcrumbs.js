...
(function() {
    ...
    console.log('[SpaceHub Breadcrumbs] Initializing...');
    ...
    function compareBreadcrumbStructures(existing, target) {
        ...
        const existingElements = Array.from(breadcrumbContainer.children).filter(child => 
            child.classList.contains('SpaceHub-breadcrumb-element')
        );
        ...
        for (let i = differences.length - 1; i >= 0; i--) {
            ...
            if (diff.action === 'add') {
                ...
                if (elementToRemove) {
                    ...
                    if (separatorToRemove && separatorToRemove.classList.contains('SpaceHub-breadcrumb-separator')) {
    ...
    async function createBreadcrumbElementFromStructure(elementDef, item) {
        ...
        element.className = 'SpaceHub-breadcrumb-element';
    ...
    function log(message, ...args) {
        console.log(`[SpaceHub Breadcrumbs] ${message}`, ...args);
    }
    
    function error(message, ...args) {
        console.error(`[SpaceHub Breadcrumbs] ${message}`, ...args);
    }
    ...
    function createBreadcrumbContainer() {
        ...
        wrapper.id = 'SpaceHub-breadcrumbs-wrapper';
        wrapper.className = 'SpaceHub-breadcrumbs-wrapper';
        ...
        breadcrumbContainer.id = 'SpaceHub-breadcrumbs';
        breadcrumbContainer.className = 'SpaceHub-breadcrumbs';
        
        // Create popover container
        const popoverContainer = document.createElement('div');
        popoverContainer.id = 'SpaceHub-popover-container';
        popoverContainer.className = 'SpaceHub-popover-container';
    ...
    function showBreadcrumbs() {
        const wrapper = document.getElementById('SpaceHub-breadcrumbs-wrapper');
    ...
    function createPopover(items, currentItem, onItemClick) {
        ...
        popover.className = 'SpaceHub-popover';
        ...
        items.forEach(item => {
            ...
            itemElement.className = 'SpaceHub-popover-item';
    ...
    function showPopover(triggerElement, popover) {
        ...
        const popoverContainer = document.getElementById('SpaceHub-popover-container');
        if (popoverContainer) {
    ...
    function createSeparator() {
        ...
        separator.className = 'SpaceHub-breadcrumb-separator';
    ...
    function initialize() {
        ...
        if (window.SpaceHubUtils) {
            log('Registering breadcrumb handler with SpaceHubUtils');
            ...
            error('SpaceHubUtils not available, breadcrumbs may not work correctly');
        }

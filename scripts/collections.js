...
(function() {
    ...
    const LOG = (...args) => console.log('[SpaceHub Collections]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub Collections]', ...args);
    const ERR = (...args) => console.error('[SpaceHub Collections]', ...args);

    // localStorage key prefix
    const STORAGE_KEY_PREFIX_SORT = 'SpaceHub_collectionSort_';
    const STORAGE_KEY_PREFIX_DIRECTION = 'SpaceHub_collectionSortDirection_';
    ...
    function initializeCollectionsHook() {
        ...
        LOG('Registering collections handler with SpaceHubUtils');

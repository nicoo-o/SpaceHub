// SpaceHub Legacy Skin Defaults (v0.3.5)
...
(function() {
                ...
                url: [
                    {
                        ...
                        urls: [
                            ...
                            `${getSpaceHubRoot()}skins/elegantKefin.css`
                        ]
                    }
                ],
                colorSchemes: []
    ...
    window.SpaceHubLegacySkinDefaults = KEFIN_TWEAKS_LEGACY_SKIN_DEFAULTS;
    
    console.log('[SpaceHub Legacy Skin Defaults] Canonical defaults (v0.3.5) loaded. Available at window.SpaceHubLegacySkinDefaults');

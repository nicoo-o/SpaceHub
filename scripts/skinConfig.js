// SpaceHub Default Skin Configuration
// Default skins provided by SpaceHub
// These skins will be merged with admin-configured skins from SpaceHubConfig
...
(function() {
    ...
    const getSpaceHubRoot = () => {
        return window.SpaceHubConfig?.SpaceHubRoot || 'https://ranaldsgift.github.io/SpaceHub/';
    }
    ...
    const KEFIN_TWEAKS_DEFAULT_SKINS_CONFIG = {
        ...
        // These will be merged with admin-configured global optional includes from SpaceHubConfig
        ...
        // These skins will be merged with skins from the main SpaceHub config
        // Admin-configured skins take priority over default skins (no duplicates by name)
            ...
            },
            {
                ...
                url: [
                    {
                        ...
                        urls: [
                            ...
                            `${getSpaceHubRoot()}skins/elegant-kefin.css`
                        ]
                    },
                    {
                        ...
                        urls: [
                            'https://cdn.jsdelivr.net/gh/lscambo13/ElegantFin@main/Theme/ElegantFin-jellyfin-theme-build-latest-minified.css',
                            `${getSpaceHubRoot()}skins/elegant-kefin.css`,                            
                            `${getSpaceHubRoot()}skins/fin-kefin-10.11.css`
                        ]
                    }
                ],
                colorSchemes: [],
                optionalIncludes: [
                    ...
                    },
                    {
                        ...
                        url: `${getSpaceHubRoot()}skins/optional/ElegantFin/cardHoverEffect.css`,
                        enabled: false
                    },
                    {
                        name: 'Center Overlay Play Button',
                        url: `${getSpaceHubRoot()}skins/optional/ElegantFin/centerPlayButton.css`,
                        enabled: false
                    },
                    {
                        name: 'Extra Overlay Buttons',
                        url: `${getSpaceHubRoot()}skins/optional/ElegantFin/extraOverlayButtons.css`,
                        enabled: false
                    },
                    {
                        name: 'Library Label Visibility',
                        url: `${getSpaceHubRoot()}skins/optional/ElegantFin/libraryLabelVisibility.css`,
                        enabled: false
                    },
                    {
                        name: 'Solid App Bar',
                        url: `${getSpaceHubRoot()}skins/optional/ElegantFin/solidAppBar.css`,
                        enabled: false
                    }
                ]
            },
                ...
                url: [
                    {
                        ...
                        urls: [
                            ...
                            `${getSpaceHubRoot()}skins/neutralfin-kefin.css`
                        ]
                    }
                ],
                colorSchemes: [],
                ...
                url: [
                    {
                        ...
                        urls: [
                            ...
                            `${getSpaceHubRoot()}skins/glassfin-kefin.css`
                        ]
                    }
                ],
                colorSchemes: [
                ...
                url: [
                    {
                        ...
                        urls: [
                            ...
                            `${getSpaceHubRoot()}skins/jamfin-kefin.css`,
                            `${getSpaceHubRoot()}skins/jamfin-kefin-10.css`
                        ]
                    },
                    {
                        majorServerVersions: [11],
                ...
                url: [
                    {
                        ...
                        urls: [
                            ...
                            `${getSpaceHubRoot()}skins/scyfin-kefin.css`
                        ]
                    },
                    {
                        majorServerVersions: [11],
                ...
                url: [
                    {
                        ...
                        urls: [
                            ...
                            `${getSpaceHubRoot()}skins/flow-kefin.css`
                        ]
                    },
                    {
                        majorServerVersions: [11],
                ...
                url: [
                    {
                        ...
                        urls: [
                            ...
                            `${getSpaceHubRoot()}skins/chromic-kefin.css`
                        ]
                    }
                ],
                optionalIncludes: [,
    ...
    window.SpaceHubDefaultSkinsConfig = KEFIN_TWEAKS_DEFAULT_SKINS_CONFIG;
    
    console.log('[SpaceHub SkinConfig] Default skin configuration loaded. Available at window.SpaceHubDefaultSkinsConfig');

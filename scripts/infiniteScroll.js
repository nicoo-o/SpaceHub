...
(function () {    
    ...
    const LOG = (...args) => console.log('[SpaceHub InfiniteScroll]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub InfiniteScroll]', ...args);
    const ERR = (...args) => console.error('[SpaceHub InfiniteScroll]', ...args);
    ...
    function addInfiniteScrollCSS() {
        ...
        const isEnabled = window.SpaceHubConfig?.scripts?.infiniteScroll !== false;
        if (!isEnabled) {

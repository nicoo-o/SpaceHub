// SpaceHub Item Details Collections
...
(function() {
    ...
    const LOG = (...args) => console.log('[SpaceHub ItemDetailsCollections]', ...args);
    const WARN = (...args) => console.warn('[SpaceHub ItemDetailsCollections]', ...args);
    const ERR = (...args) => console.error('[SpaceHub ItemDetailsCollections]', ...args);
    ...
    async function populateCollectionsCache(invalidate = false) {
        ...
        const cache = new window.IndexedDBCache('SpaceHub_', CACHE_TTL);

        ...
        if (existingHero) {
            ...
            setTimeout(() => {
                ...
                if (titleEl) titleEl.innerHTML = buildKineticTitle(item.Name);
                    ...
                    metaEl.innerHTML = `
                        <span class="sh-hero-badge sh-hero-badge--rt sh-score-rt" role="button" tabindex="0" title="Consensus et avis Rotten Tomatoes (Survoler pour afficher)">
                            ${rtSvg}
                            <span>${rtScore}%</span>
                            <span class="sh-badge-hint-dot"></span>
                        </span>
                        <span class="sh-hero-badge sh-hero-badge--imdb sh-score-imdb" role="button" tabindex="0" title="Note et répartition des spectateurs IMDb (Survoler pour afficher)">
                            ${imdbSvg}
                            <span>${imdbScore}</span>
                            <span class="sh-badge-hint-dot"></span>
                        </span>
